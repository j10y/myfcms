		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
						...
						<table width="90%" height="30" border="0" cellpadding="0"
							...
							<tr>
								<td class="queryConditionTitleCell"><fmt:message
									key="exception.msg.systemException" /></td>
							</tr>
						</table>
						</td>
					</tr>
				...
				<table width="97%" border="0" cellpadding="5" cellspacing="1"
					...
					<tr>
						<td width="104" height="117">&nbsp;</td>
						<td><fmt:message key="public.label.detailInfo" />:<br>
						<app:out value="${applicationException.message}" /> <c:if
							test="${applicationException.cause != null}">
							<app:out value="${applicationException.cause.message}" />
						</c:if> <br>
						<input id="returnButton"
							type="button"
							onclick="javascript:oneStepBackward();">
						</div>
						</td>
					</tr>
				</table>
