 ...
 public class XmlConvertTestCase
 {
   public static void main(String[] args)
   {
     ...
     while (ids.hasNext()) {
       ...
       Integer intWidth = Integer.valueOf(new Integer(width).intValue() + 10);
 
       String height = pNode.attributeValue("h");
       Integer intHeight = Integer.valueOf(new Integer(height).intValue() + 10);
     ...
     while (tranIt.hasNext()) {
       ...
       if ((startNode != null) && (endNode != null)) {
         ...
         if ((startRef != null) && (endRef != null)) {
           Element newStartNode = (Element)newNodeMap.get(startRef);
   ...
   public static Map<String, Element> parseDrawXml(Set transitionSet)
   {
     ...
     List figures = rootEl.selectNodes("/drawing/figures");
