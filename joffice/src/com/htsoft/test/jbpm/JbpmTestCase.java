 ...
 public class JbpmTestCase extends BaseTestCase
 {
   ...
   public void deploy()
   {
     String id = this.repositoryService.createDeployment().addResourceFromClasspath("com/htsoft/test/jbpm/test.jpdl.xml").deploy();
     System.out.println("deployId:" + id);
   }
 
   public void deploySignAll() {
     String id = this.repositoryService.createDeployment().addResourceFromClasspath("com/htsoft/test/jbpm/signAll2.jpdl.xml").deploy();
     System.out.println("deployId:" + id);
   }
   ...
   public void getByTaskId()
   {
     ...
     try {
       ...
       if (activityFind == null) break label94;
       List list = activityFind.getOutgoingTransitions();
       label94: System.out.println("size:" + list.size());
     }
     finally
     {
       env.close();
   ...
   public void signAll()
   {
     ...
     List userTaskList = this.taskService.findPersonalTasks("3");
     ...
     List userTaskList6 = this.taskService.findPersonalTasks("6");
 ...
 * Qualified Name:     com.htsoft.test.jbpm.JbpmTestCase
