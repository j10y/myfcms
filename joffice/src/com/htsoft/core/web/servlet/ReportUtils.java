...
public class ReportUtils {
	...
	public void complieJaxml(String jaxmlPath, String jasperPath) throws JRException {
	...
	public void servletExportPDF(String jasperPath, Map params, List sourceList, String fileName)
		...
		servletExportDocument(DocType.PDF, jasperPath, params, sourceList, fileName);
	}
	...
	public void servletExportHTML(String jasperPath, Map params, List sourceList, String imageUrl)
		...
		this.session.setAttribute("net.sf.jasperreports.j2ee.jasper_print", jasperPrint);
	...
	public void servletExportExcel(String jasperPath, Map params, List sourceList, String fileName)
			throws JRException, IOException, ServletException {
		servletExportDocument(DocType.XLS, jasperPath, params, sourceList, fileName);
	}

	public void servletExportDocument(DocType docType, String jasperPath, Map params,
			List sourceList, String fileName) throws JRException, IOException, ServletException {
		...
		exporter.setParameter(JRExporterParameter.JASPER_PRINT, getPrintWithBeanList(jasperPath,
				params, sourceList));
