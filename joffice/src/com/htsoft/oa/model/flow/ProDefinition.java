...
public class ProDefinition extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.defId, rhs.defId).append(this.name, rhs.name)
				.append(this.description, rhs.description).append(this.createtime, rhs.createtime)
				.append(this.deployId, rhs.deployId).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.defId).append(this.name)
				.append(this.description).append(this.createtime).append(this.deployId)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("defId", this.defId).append("name", this.name)
				.append("description", this.description).append("createtime", this.createtime)
