...
public class Duty extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.dutyId, rhs.dutyId).append(this.fullname,
				rhs.fullname).append(this.startTime, rhs.startTime).append(this.endTime,
				rhs.endTime).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.dutyId).append(this.fullname)
				.append(this.startTime).append(this.endTime).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("dutyId", this.dutyId).append("fullname",
				this.fullname).append("startTime", this.startTime).append("endTime", this.endTime)
				.toString();
	}
}
