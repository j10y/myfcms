 ...
 public class ErrandsRegister extends BaseModel
 {
   ...
   public static final Short STATUS_UNCHECKED = Short.valueOf(0);
 
   public static final Short STATUS_APPROVAL = Short.valueOf(1);
 
   public static final Short STATUS_UNAPPROVAL = Short.valueOf(2);
 
   public static final Short FLAG_OVERTIME = Short.valueOf(0);
 
   public static final Short FLAG_LEAVE = Short.valueOf(1);
 
   public static final Short FLAG_OUT = Short.valueOf(2);
