...
public class HolidayRecord extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.recordId, rhs.recordId).append(this.startTime,
				rhs.startTime).append(this.endTime, rhs.endTime).append(this.userId, rhs.userId)
				.append(this.isAll, rhs.isAll).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.recordId).append(
				this.startTime).append(this.endTime).append(this.userId).append(this.isAll)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("recordId", this.recordId).append("startTime",
				this.startTime).append("endTime", this.endTime).append("userId", this.userId)
				.append("isAll", this.isAll).toString();
	}
}
