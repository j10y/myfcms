 ...
 {
   public static final Short SHARED = Short.valueOf(1);
   public static final Short NOT_SHARED = Short.valueOf(0);
 
   public static final Short HAVE_ATTACH = Short.valueOf(1);
   public static final Short NOT_HAVE_ATTACH = Short.valueOf(0);
   ...
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973)
       ...
       .append(this.haveAttach)
       .append(this.sharedUserIds)
       .append(this.sharedDepIds)
       .append(this.sharedRoleIds)
