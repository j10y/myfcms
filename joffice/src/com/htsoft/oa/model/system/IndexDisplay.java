...
public class IndexDisplay extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.indexId, rhs.indexId).append(this.portalId,
				rhs.portalId).append(this.colNum, rhs.colNum).append(this.rowNum, rhs.rowNum)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.indexId)
				.append(this.portalId).append(this.colNum).append(this.rowNum).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("indexId", this.indexId).append("portalId",
				this.portalId).append("colNum", this.colNum).append("rowNum", this.rowNum)
				.toString();
	}
}
