...
public class UserSub extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.subId, rhs.subId).append(this.userId, rhs.userId)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.subId).append(this.userId)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("subId", this.subId).append("userId", this.userId)
				.toString();
	}
}
