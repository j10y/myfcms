...
public class FunUrl extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.urlId, rhs.urlId).append(this.urlPath, rhs.urlPath)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.urlId).append(this.urlPath)
				.toHashCode();
	}
