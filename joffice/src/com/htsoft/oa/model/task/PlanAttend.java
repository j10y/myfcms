...
public class PlanAttend extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.attendId, rhs.attendId)
				.append(this.isDep, rhs.isDep).append(this.isPrimary, rhs.isPrimary).isEquals();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("attendId", this.attendId).append("isDep",
				this.isDep).append("isPrimary", this.isPrimary).toString();
	}
}
