 ...
 {
   public static final Short STATUS_UNFINISHED = Short.valueOf(0);
 
   public static final Short STATUS_FINISHED = Short.valueOf(1);
 
   public static final Short URGENT_COMMON = Short.valueOf(0);
 
   public static final Short URGENT_IMPORTANT = Short.valueOf(1);
 
   public static final Short URGENT_INST = Short.valueOf(2);
   ...
   public String getColor() { if (STATUS_FINISHED.equals(this.status)) {
       return "#D5E4BD";
     }
