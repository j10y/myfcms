...
public class CartRepair extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.repairId, rhs.repairId).append(this.repairDate,
				rhs.repairDate).append(this.reason, rhs.reason).append(this.executant,
				rhs.executant).append(this.notes, rhs.notes)
				.append(this.repairType, rhs.repairType).append(this.fee, rhs.fee).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.repairId).append(
				this.repairDate).append(this.reason).append(this.executant).append(this.notes)
				.append(this.repairType).append(this.fee).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("repairId", this.repairId).append("repairDate",
				this.repairDate).append("reason", this.reason).append("executant", this.executant)
				.append("notes", this.notes).append("repairType", this.repairType).append("fee",
						this.fee).toString();
	}
}
