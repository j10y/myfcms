...
public class Book extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.bookId, rhs.bookId).append(this.bookName,
				rhs.bookName).append(this.author, rhs.author).append(this.isbn, rhs.isbn).append(
				this.publisher, rhs.publisher).append(this.price, rhs.price).append(this.location,
				rhs.location).append(this.department, rhs.department).append(this.amount,
				rhs.amount).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.bookId).append(this.bookName)
				.append(this.author).append(this.isbn).append(this.publisher).append(this.price)
				.append(this.location).append(this.department).append(this.amount).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("bookId", this.bookId).append("bookName",
				this.bookName).append("author", this.author).append("isbn", this.isbn).append(
				"publisher", this.publisher).append("price", this.price).append("location",
				this.location).append("department", this.department).append("amount", this.amount)
				.toString();
	}
}
