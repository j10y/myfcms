...
public class EmpProfile extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.profileId, rhs.profileId).append(this.profileNo,
				rhs.profileNo).append(this.fullname, rhs.fullname)
				.append(this.address, rhs.address).append(this.birthday, rhs.birthday).append(
						this.homeZip, rhs.homeZip).append(this.sex, rhs.sex).append(this.marriage,
						rhs.marriage).append(this.designation, rhs.designation).append(
						this.position, rhs.position).append(this.phone, rhs.phone).append(
						this.mobile, rhs.mobile).append(this.openBank, rhs.openBank).append(
						this.bankNo, rhs.bankNo).append(this.qq, rhs.qq).append(this.email,
						rhs.email).append(this.hobby, rhs.hobby)
				.append(this.religion, rhs.religion).append(this.party, rhs.party).append(
						this.nationality, rhs.nationality).append(this.race, rhs.race).append(
						this.birthPlace, rhs.birthPlace).append(this.eduDegree, rhs.eduDegree)
				...
				.append(this.awardPunishCase, rhs.awardPunishCase).append(this.trainingCase,
						rhs.trainingCase).append(this.workCase, rhs.workCase).append(this.idCard,
						rhs.idCard).append(this.photo, rhs.photo).append(this.standardMiNo,
						rhs.standardMiNo).append(this.standardMoney, rhs.standardMoney).append(
						this.standardName, rhs.standardName).append(this.creator, rhs.creator)
				.append(this.createtime, rhs.createtime).append(this.checkName, rhs.checkName)
				.append(this.checktime, rhs.checktime).append(this.approvalStatus,
						rhs.approvalStatus).append(this.opprovalOpinion, rhs.opprovalOpinion)
				.append(this.memo, rhs.memo).append(this.depName, rhs.depName).append(this.depId,
						rhs.depId).append(this.delFlag, rhs.delFlag)
				.append(this.userId, rhs.userId).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.profileId).append(
				this.profileNo).append(this.fullname).append(this.address).append(this.birthday)
				.append(this.homeZip).append(this.sex).append(this.marriage).append(
						this.designation).append(this.position).append(this.phone).append(
						this.mobile).append(this.openBank).append(this.bankNo).append(this.qq)
				.append(this.email).append(this.hobby).append(this.religion).append(this.party)
				.append(this.nationality).append(this.race).append(this.birthPlace).append(
						this.eduDegree).append(this.eduMajor).append(this.eduCollege).append(
						this.startWorkDate).append(this.eduCase).append(this.awardPunishCase)
				.append(this.trainingCase).append(this.workCase).append(this.idCard).append(
						this.photo).append(this.standardMiNo).append(this.standardMoney).append(
						this.standardName).append(this.creator).append(this.createtime).append(
						this.checkName).append(this.checktime).append(this.approvalStatus).append(
						this.memo).append(this.depName).append(this.depId).append(this.delFlag)
				.append(this.opprovalOpinion).append(this.userId).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("profileId", this.profileId).append("profileNo",
				this.profileNo).append("fullname", this.fullname).append("address", this.address)
				.append("birthday", this.birthday).append("homeZip", this.homeZip).append("sex",
						this.sex).append("marriage", this.marriage).append("designation",
						this.designation).append("position", this.position).append("phone",
						this.phone).append("mobile", this.mobile).append("openBank", this.openBank)
				.append("bankNo", this.bankNo).append("qq", this.qq).append("email", this.email)
				.append("hobby", this.hobby).append("religion", this.religion).append("party",
						this.party).append("nationality", this.nationality).append("race",
						this.race).append("birthPlace", this.birthPlace).append("eduDegree",
						this.eduDegree).append("eduMajor", this.eduMajor).append("eduCollege",
						this.eduCollege).append("startWorkDate", this.startWorkDate).append(
						"eduCase", this.eduCase).append("awardPunishCase", this.awardPunishCase)
				.append("trainingCase", this.trainingCase).append("workCase", this.workCase)
				.append("idCard", this.idCard).append("photo", this.photo).append("standardMiNo",
						this.standardMiNo).append("standardMoney", this.standardMoney).append(
						"standardName", this.standardName).append("creator", this.creator).append(
						"createtime", this.createtime).append("checkName", this.checkName).append(
						"checktime", this.checktime).append("approvalStatus", this.approvalStatus)
				.append("memo", this.memo).append("depName", this.depName).append("depId",
						this.depId).append("delFlag", this.delFlag).append("opprovalOpinion",
						this.opprovalOpinion).append("userId", this.userId).toString();
	}
}
