...
public class JobChange extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.changeId, rhs.changeId).append(this.profileId,
				rhs.profileId).append(this.profileNo, rhs.profileNo).append(this.userName,
				rhs.userName).append(this.orgJobId, rhs.orgJobId).append(this.orgStandardId,
				rhs.orgStandardId).append(this.newStandardId, rhs.newStandardId).append(
				this.orgJobName, rhs.orgJobName).append(this.newJobId, rhs.newJobId).append(
				this.newJobName, rhs.newJobName).append(this.orgStandardNo, rhs.orgStandardNo)
				.append(this.orgStandardName, rhs.orgStandardName).append(this.orgDepId,
						rhs.orgDepId).append(this.orgDepName, rhs.orgDepName).append(
						this.orgTotalMoney, rhs.orgTotalMoney).append(this.newStandardNo,
						rhs.newStandardNo).append(this.newStandardName, rhs.newStandardName)
				.append(this.newDepId, rhs.newDepId).append(this.newDepName, rhs.newDepName)
				.append(this.newTotalMoney, rhs.newTotalMoney).append(this.changeReason,
						rhs.changeReason).append(this.regName, rhs.regName).append(this.regTime,
						rhs.regTime).append(this.checkName, rhs.checkName).append(this.checkTime,
						rhs.checkTime).append(this.checkOpinion, rhs.checkOpinion).append(
						this.status, rhs.status).append(this.memo, rhs.memo).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.changeId).append(
				this.profileId).append(this.profileNo).append(this.userName).append(this.orgJobId)
				.append(this.orgJobName).append(this.newJobId).append(this.newJobName).append(
						this.orgStandardNo).append(this.orgStandardName).append(this.orgDepId)
				.append(this.orgStandardId).append(this.newStandardId).append(this.orgDepName)
				.append(this.orgTotalMoney).append(this.newStandardNo).append(this.newStandardName)
				.append(this.newDepId).append(this.newDepName).append(this.newTotalMoney).append(
						this.changeReason).append(this.regName).append(this.regTime).append(
						this.checkName).append(this.checkTime).append(this.checkOpinion).append(
						this.status).append(this.memo).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("changeId", this.changeId).append("profileId",
				this.profileId).append("profileNo", this.profileNo).append("userName",
				this.userName).append("orgJobId", this.orgJobId).append("orgJobName",
				this.orgJobName).append("newJobId", this.newJobId).append("newJobName",
				this.newJobName).append("orgStandardId", this.orgStandardId).append(
				"newStandardId", this.newStandardId).append("orgStandardNo", this.orgStandardNo)
				.append("orgStandardName", this.orgStandardName).append("orgDepId", this.orgDepId)
				.append("orgDepName", this.orgDepName).append("orgTotalMoney", this.orgTotalMoney)
				.append("newStandardNo", this.newStandardNo).append("newStandardName",
						this.newStandardName).append("newDepId", this.newDepId).append(
						"newDepName", this.newDepName).append("newTotalMoney", this.newTotalMoney)
				.append("changeReason", this.changeReason).append("regName", this.regName).append(
						"regTime", this.regTime).append("checkName", this.checkName).append(
						"checkTime", this.checkTime).append("checkOpinion", this.checkOpinion)
