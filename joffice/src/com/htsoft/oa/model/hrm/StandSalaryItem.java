...
public class StandSalaryItem extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.itemId, rhs.itemId).append(this.itemName,
				rhs.itemName).append(this.amount, rhs.amount).append(this.salaryItemId,
				rhs.salaryItemId).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.itemId).append(this.itemName)
				.append(this.amount).append(this.salaryItemId).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("itemId", this.itemId).append("itemName",
				this.itemName).append("amount", this.amount).append("salaryItemId",
				this.salaryItemId).toString();
	}
}
