...
public class NewsComment extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.commentId, rhs.commentId).append(this.content,
				rhs.content).append(this.createtime, rhs.createtime).append(this.fullname,
				rhs.fullname).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.commentId).append(
				this.content).append(this.createtime).append(this.fullname).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("commentId", this.commentId).append("content",
				this.content).append("createtime", this.createtime).append("fullname",
