...
public class LoginAction extends BaseAction {
	...
	public String login() {
		...
		if (login.booleanValue()) {
			...
			if ((rememberMe != null) && (rememberMe.equals("on"))) {
				...
				String signatureValue = DigestUtils.md5Hex(this.username + ":" + tokenExpiryTime
	...
	protected Cookie makeValidCookie(long expiryTime, String tokenValueBase64) {
		...
		cookie
				.setPath((org.springframework.util.StringUtils.hasLength(request.getContextPath())) ? request
						.getContextPath()
						: "/");
		return cookie;
	}
