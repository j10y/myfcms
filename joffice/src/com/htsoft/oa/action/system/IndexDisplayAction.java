 ...
 public class IndexDisplayAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List list = this.indexDisplayService.getAll(filter);
   ...
   public String save()
   {
     ...
     PanelItem[] panelItems = (PanelItem[])gson.fromJson(items, 
       [Lcom.htsoft.oa.model.system.PanelItem.class);
     AppUser user = ContextUtil.getCurrentUser();
     List list = this.indexDisplayService.findByUser(user.getUserId());
