 ...
 public class ContractAction extends BaseAction
 {
   ...
   public String save()
   {
     ...
     if (pass)
     {
       ...
       if (StringUtils.isNotEmpty(this.data)) {
         Gson gson = new Gson();
         ContractConfig[] contractConfigs = (ContractConfig[])gson.fromJson(this.data, [Lcom.htsoft.oa.model.customer.ContractConfig.class);
   ...
   public String removeFile()
   {
     ...
     FileAttach removeFile = (FileAttach)this.fileAttachService.get(new Long(this.contractAttachIDs));
