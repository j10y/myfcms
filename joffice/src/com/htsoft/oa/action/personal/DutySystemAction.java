...
public class DutySystemAction extends BaseAction {
	...
	public String setting() {
		...
		if (this.dutySystem != null) {
			...
			buff.append("day0:'',day1:'',day2:'',day3:'',day4:'',day5:'',day6:''").append(
	...
	public String combo() {
		...
		for (DutySystem dutySystem : dutySystemList) {
			sb.append("['").append(dutySystem.getSystemId()).append("','").append(
					dutySystem.getSystemName()).append("'],");
		}
 ...
 * Qualified Name: com.htsoft.oa.action.personal.DutySystemAction JD-Core
 * Version: 0.5.4
 */