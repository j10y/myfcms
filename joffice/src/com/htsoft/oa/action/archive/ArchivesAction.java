 ...
 public class ArchivesAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List list = this.archivesService.getAll(filter);
   ...
   public String cruList()
   {
     ...
     List list = this.archivesService.findByUserOrRole(appUser
       .getUserId(), appUser.getRoles(), pb);
     Type type = new TypeToken() {
     }.getType();
     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
   ...
   public String save()
   {
     ...
     if (StringUtils.isNotEmpty(arcRecfileIds)) {
       List list = this.archivesDocService.findByAid(this.archives
         .getArchivesId());
       ...
       for (String id : fileIds) {
         ...
         archivesDoc.setDocStatus(Short.valueOf(1));
   ...
   public String saveIssue()
   {
     ...
     if (StringUtils.isNotEmpty(docs)) {
       ...
       ArchivesDoc[] archivesDocs = (ArchivesDoc[])gson.fromJson(docs, 
         [Lcom.htsoft.oa.model.archive.ArchivesDoc.class);
