 ...
 public class ArchivesHandleAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     StringBuffer buff = new StringBuffer("{success:true,'totalCounts':")
       ...
       ",result:");
     JSONSerializer serializer = JsonUtil.getJSONSerializer(new String[] { "createtime", "archives.issueDate", "archives.createtime" });
     buff.append(serializer.exclude(new String[] { "archives.archRecType", "class" }).serialize(list));
     buff.append("}");
   ...
   public String get()
   {
     ArchivesHandle archivesHandle = (ArchivesHandle)this.archivesHandleService.get(this.handleId);
 ...
 * Qualified Name:     com.htsoft.oa.action.archive.ArchivesHandleAction
