 ...
 public class ArchivesAttendAction extends BaseAction
 {
   ...
   public String get()
   {
     ArchivesAttend archivesAttend = (ArchivesAttend)this.archivesAttendService.get(this.attendId);
 ...
 * Qualified Name:     com.htsoft.oa.action.archive.ArchivesAttendAction
