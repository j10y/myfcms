 ...
 public class FormDefAction extends BaseAction
 {
   ...
   public String nodes()
   {
     List nodes = this.jbpmService.getTaskNodesByDefId(new Long(this.defId));
   ...
   public String addAll()
   {
     ...
     ProDefinition proDefinition = (ProDefinition)this.proDefinitionService.get(new Long(this.defId));
   ...
   public String select()
   {
     ...
     List list = this.formDefService.getAll(filter);
   ...
   public String list()
   {
     ...
     List formDefs = this.formDefService.getByDeployId(proDefinition.getDeployId());
   ...
   public String save()
   {
     ...
     ExtFormItem[] formItems = (ExtFormItem[])gson.fromJson("[" + formItemDef + "]", [Lcom.htsoft.oa.model.flow.ExtFormItem.class);
