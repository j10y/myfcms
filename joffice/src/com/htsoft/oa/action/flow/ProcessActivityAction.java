 ...
 public class ProcessActivityAction extends BaseAction
 {
     ...
     throws Exception
   {
     ...
     if (this.taskId != null) {
       ...
       List trans = this.jbpmService.getTransitionsByTaskId(this.taskId.toString());
     ...
     try
     {
       ...
       formUiJs = VelocityEngineUtils.mergeTemplateIntoString(this.flowVelocityEngine, ProcessActivityAssistant.getCommonFormPath(this.activityName), "UTF-8", model);
     }
   ...
   public String freeTrans()
   {
     ...
     List trans = this.jbpmService.getFreeTransitionsByTaskId(this.taskId.toString());
 
     for (Transition tran : trans) {
       sb.append("[").append(gson.toJson(tran.getName())).append(",").append(gson.toJson(tran.getDestination().getName())).append("],");
     }
   ...
   protected Map<String, ParamField> constructFieldMap()
   {
     ...
     Map map = ProcessActivityAssistant.constructFieldMap(proDefinition.getName(), this.activityName);
