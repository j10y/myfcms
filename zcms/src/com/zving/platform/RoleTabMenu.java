 ...
 public class RoleTabMenu extends Page
 {
   ...
   public static void dg1DataBind(DataGridAction dga) {
     ...
     if (!("admin".equals(User.getUserName()))) {
       dt = dt.filter(new Filter() {
         public boolean filter(Object obj) {
           DataRow dr = (DataRow)obj;
           return Priv.getPriv(User.getUserName(), "menu", dr.getString("id"), "menu_browse");
         }
       });
     }
   ...
   public void getCheckedMenu() {
     ...
     String sql = "select ID from ZDPrivilege where OwnerType=? and Owner=? and PrivType='menu' and ID like '" + SiteID + "-%' and Value='1'";
   ...
   public void save() {
     ...
     QueryBuilder qb = new QueryBuilder("where OwnerType=? and Owner=? and PrivType='menu' and ID like '" + SiteID + "-%'", "R", RoleCode);
 ...
 * Qualified Name:     com.zving.platform.RoleTabMenu
