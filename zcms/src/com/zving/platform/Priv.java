...
public class Priv {
	...
	public static void updateAllPriv(String UserName) {
		Object obj = new QueryBuilder("select UserName from ZDUser where UserName=?", UserName)
				.executeOneValue();
		if (obj == null) {
	...
	public static boolean getPriv(String UserName, String PrivType, String ID, String Code) {
		...
		if ((roleCodeList != null) && (roleCodeList.size() != 0)) {
			return RolePriv.getRolePriv((String[]) roleCodeList.toArray(new String[roleCodeList
					.size()]), PrivType, ID, Code);
		}
		return false;
	}
	...
	public static boolean isValidURL(String URL) {
		...
		return ((!(StringUtil.isNotEmpty(menuID))) || (getPriv(User.getUserName(), "menu",
				Application.getCurrentSiteID() + "-" + menuID, "menu_browse")));
	}
}

/*
 * Location: F:\JAVA\Tomcat5.5\webapps\zcms\WEB-INF\classes\ Qualified Name:
 * com.zving.platform.Priv JD-Core Version: 0.5.3
 */