 ...
 public class BZCAttachmentSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 29, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 30, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 31, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 32, 50, 0, false, false) };
   ...
   public BZCAttachmentSchema()
   {
     ...
     this.HasSetFlag = new boolean[33];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 29) { this.BackupNo = ((String)v); return; }
     if (i == 30) { this.BackupOperator = ((String)v); return; }
     if (i == 31) { this.BackupTime = ((Date)v); return; }
     if (i != 32) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 29) return this.BackupNo;
     if (i == 30) return this.BackupOperator;
     if (i == 31) return this.BackupTime;
     if (i == 32) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZCAttachmentSchema
