 ...
 public class BZCDatabaseSchema extends Schema
 {
   ...
   protected static final String _UpdateAllSQL = "update BZCDatabase set ID=?,SiteID=?,Name=?,ServerType=?,Address=?,Port=?,UserName=?,Password=?,DBName=?,TestTable=?,Memo=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";
 ...
 * Qualified Name:     com.zving.schema.BZCDatabaseSchema
