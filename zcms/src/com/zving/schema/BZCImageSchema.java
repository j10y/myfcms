 ...
 public class BZCImageSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 37, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 38, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 39, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 40, 50, 0, false, false) };
   ...
   public BZCImageSchema()
   {
     ...
     this.HasSetFlag = new boolean[41];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 36) { this.ModifyTime = ((Date)v); return; }
     if (i == 37) { this.BackupNo = ((String)v); return; }
     if (i == 38) { this.BackupOperator = ((String)v); return; }
     if (i == 39) { this.BackupTime = ((Date)v); return; }
     if (i != 40) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 37) return this.BackupNo;
     if (i == 38) return this.BackupOperator;
     if (i == 39) return this.BackupTime;
     if (i == 40) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZCImageSchema
