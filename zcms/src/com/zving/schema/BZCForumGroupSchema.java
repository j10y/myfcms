 ...
 public class BZCForumGroupSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 30, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 31, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 32, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 33, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 30) { this.BackupNo = ((String)v); return; }
     if (i == 31) { this.BackupOperator = ((String)v); return; }
     if (i == 32) { this.BackupTime = ((Date)v); return; }
     if (i != 33) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 30) return this.BackupNo;
     if (i == 31) return this.BackupOperator;
     if (i == 32) return this.BackupTime;
     if (i == 33) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZCForumGroupSchema
