 ...
 public class BZCForumScoreSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 27, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 28, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 29, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 30, 50, 0, false, false) };
   ...
   public BZCForumScoreSchema()
   {
     ...
     this.HasSetFlag = new boolean[31];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 26) { this.ModifyTime = ((Date)v); return; }
     if (i == 27) { this.BackupNo = ((String)v); return; }
     if (i == 28) { this.BackupOperator = ((String)v); return; }
     if (i == 29) { this.BackupTime = ((Date)v); return; }
     if (i != 30) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 27) return this.BackupNo;
     if (i == 28) return this.BackupOperator;
     if (i == 29) return this.BackupTime;
     if (i == 30) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZCForumScoreSchema
