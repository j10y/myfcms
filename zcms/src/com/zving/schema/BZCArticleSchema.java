 ...
 public class BZCArticleSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 49, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 50, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 51, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 52, 50, 0, false, false) };
   ...
   public BZCArticleSchema()
   {
     ...
     this.HasSetFlag = new boolean[53];
   }
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 48) { this.ModifyTime = ((Date)v); return; }
     if (i == 49) { this.BackupNo = ((String)v); return; }
     if (i == 50) { this.BackupOperator = ((String)v); return; }
     if (i == 51) { this.BackupTime = ((Date)v); return; }
     if (i != 52) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 49) return this.BackupNo;
     if (i == 50) return this.BackupOperator;
     if (i == 51) return this.BackupTime;
     if (i == 52) return this.BackupMemo;
     return null;
   }
