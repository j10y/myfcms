 ...
 public class BZCTagSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("TagText", 1, 5, 400, 0, true, false), 
   ...
   protected static final String _UpdateAllSQL = "update BZCTag set ID=?,Code=?,Name=?,SiteID=?,Type=?,TagText=?,Prop1=?,Prop2=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 5) { this.TagText = ((String)v); return; }
