 ...
 public class StatUtil
 {
   ...
   public static long convertIP(String ip)
   {
     ...
     return (Long.parseLong(arr1[0]) * 16777216L + Long.parseLong(arr1[1]) * 65536L + Long.parseLong(arr1[2]) * 256L + 
   ...
   public static String getDistrictCode(String strIP)
   {
     ...
     for (int j = 0; j < DistrictCodes.length; ++j) {
       ...
       if (ip < arr[0]) continue; if (ip > arr[(arr.length - 1)]) {
         continue;
       }
   ...
   public static String getOS(String useragent) {
     ...
     if (useragent.indexOf("Windows NT") > 0)
       return "Windows NT";
     if ((useragent.indexOf("Windows 9") > 0) || (useragent.indexOf("Windows 4") > 0))
       return "Windows 9x";
     if ((useragent.indexOf("Unix") > 0) || (useragent.indexOf("SunOS") > 0) || (useragent.indexOf("BSD") > 0))
       return "Unix";
     ...
     if (useragent.indexOf("BlackBerry") > 0)
       return "BlackBerry";
     if ((useragent.indexOf("SymbianOS") > 0) || (useragent.indexOf("Series") > 0)) {
       return "Symbian";
     }
     return "其他";
   }
 ...
 * Qualified Name:     com.zving.cms.stat.StatUtil
