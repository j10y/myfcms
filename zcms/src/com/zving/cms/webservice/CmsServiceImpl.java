   ...
   implements CmsService
 {
   ...
   public boolean publishCatalog(long ID)
   {
     try
     {
       LongTimeTask ltt = new LongTimeTask(ID) { private final long val$ID;
 
         public void execute() { Publisher p = new Publisher();
           p.publishCatalog(this.val$ID, true, true, this);
           setPercent(100);
         }
       };
       ltt.start();
 ...
 * Qualified Name:     com.zving.cms.webservice.CmsServiceImpl
