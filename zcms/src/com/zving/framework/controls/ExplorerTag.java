     ...
     throws JspException
   {
     try
     {
       ...
       if ((this.type == 0) || (this.type == 1)) {
         String html = FileUtil.readText(ExplorerTag.class.getResourceAsStream("File.template"), "UTF-8");
         ...
         for (int i = 0; i < arr.length; ++i) {
           if ((arr[i] != null) && (!(arr[i].equals("")))) {
             ...
             psb.append(TButtonTag.getHtml("Explorer.goPath('" + jsb + "')", "<img src='" + 
               Config.getContextPath() + "Platform/Images/none.gif'>", "/" + jsb));
           }
         }
         psb.append("</select>");
         ...
         try
         {
           ...
           if ((this.filter != null) && (!("".equals(this.filter))))
           {
             ...
             dt = getFileInfoDataTable(filePath, FileFilterUtils.makeSVNAware(
 ...
 * Qualified Name:     com.zving.framework.controls.ExplorerTag
