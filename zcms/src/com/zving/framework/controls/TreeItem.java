 ...
 public class TreeItem extends HtmlP
   implements Cloneable
 {
   ...
   public String getOuterHtml()
   {
     ...
     item.setAttribute("oncontextmenu", 
     ...
     if ((this.isLeaf) && (this.isLast)) {
       text = "<img src='" + prefix + 
         "Icons/treeicon07.gif" + "'>" + text;
     }
 
     if ((this.isLeaf) && (!(this.isLast))) {
       text = "<img src='" + prefix + 
         "Icons/treeicon06.gif" + "'>" + 
         text;
     }
