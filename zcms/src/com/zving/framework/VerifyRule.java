     ...
     try {
       for (int i = 0; i < this.Features.length; ++i) {
         ...
         label880: if (fName.equals("Any")) {
           ...
           if (value == null) continue; if (value.equals("")) {
             continue;
           }
           ...
           try
           {
             ...
             if ((op.equals("=")) && (value.length() != len)) {
               ...
               verifyFlag = false; break label880: }
             if ((op.equals(">")) && (value.length() <= len)) {
       ...
       if ((sqlFlag) && 
         ...
         (value.indexOf(33) > 0) || (value.indexOf(" like ") > 0) || (value.indexOf(61) > 0) || 
         (value.indexOf(62) > 0) || (value.indexOf(60) > 0)))) {
 ...
 * Qualified Name:     com.zving.framework.VerifyRule
