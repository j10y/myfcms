 ...
 public class ChineseSpelling
 {
   ...
   private static LinkedHashMap SpellMap;
   ...
   static
   {
     ...
     HZALL = new String[][] { 
       ...
       { "Guai", "怪拐乖掴叏哙噲夬恠枴柺箉罫" }, 
       { "Guan", "关管官观馆惯罐灌冠贯棺纶盥矜莞掼涫鳏鹳倌丱串卝婠悹悺慣懽摜斡果桄樌櫬權毌沦泴淉淪潅爟琯瓘痯瘝癏矔礶祼窤筦綸罆舘萖蒄覌観觀貫躀輨遦錧鏆鑵閞関闗關雚館鰥鱞鱹鳤鵍鸛" }, 
       ...
       { "Sheng", "声省剩生升绳胜盛圣甥牲乘晟渑眚笙嵊丞乗偗剰勝呏垩墭姓娍媵憴斘昇晠曻枡榺橳殅殸泩渻湦澠焺狌珄琞甸竔箵縄繩聖聲苼蕂譝貹賸鉎鍟阩陞陹鱦鵿鼪" }, 
       { 
       "Shi", 
     ...
     chartable = new char[] { 21834, 33453, 25830, 25645, 34558, 21457, 22134, 
       21704, 21704, 20987, 21888, 22403, 22920, 25343, 21734, 21866, 26399, 
       28982, 25746, 22604, 22604, 22604, 25366, 26132, 21387, 21277, 24231 };
 
     alphatable = new char[] { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 
 ...
 * Qualified Name:     com.zving.framework.utility.ChineseSpelling
