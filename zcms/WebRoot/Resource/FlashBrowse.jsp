...
<table width="100%" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td style="padding:0px 5px;"><z:datagrid id="dg1"
			method="com.zving.cms.resource.AttachmentLib.dg1DataBindFlashBrowse"
			size="10">
			<table class="dataTable" cellspacing="0" cellpadding="2" width="100%">
				<tr ztype="head" class="dataTableHead">
					...
					<td width="15%"><b>Flash名称</b></td>
					<td width="20%"><b>Flash描述</b></td>
					<td width="15%"><b>Flash大小</b></td>
					<td width="10%"><b>Flash格式</b></td>
					<td width="9%"><b>上传用户</b></td>
					<td width="22%"><b>上传时间</b></td>
				</tr>
