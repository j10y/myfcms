...
<z:init method="com.zving.platform.UserList.initEditDialog">
<form id="form2">
	  ...
	  <fieldset>
		<legend><label>所属角色</label></legend>
		  <table width="100%" border="0" cellpadding="2" cellspacing="0">
			<tr>
			<td>
	    <z:tree id="tree1" style="width:230px;height:300px" method="com.zving.platform.UserList.initEditRoleTree">
	      <p cid='${RoleCode}' >
