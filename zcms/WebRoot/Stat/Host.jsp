...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",690,300,"com.zving.cms.stat.report.SourceReport.getHostChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.zving.cms.stat.report.SourceReport.dgHostDataBind"
