...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.zving.cms.stat.report.LoyaltyReport.getVisitFreqChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.zving.cms.stat.report.LoyaltyReport.dgVisitFreqDataBind"
