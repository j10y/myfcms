...
function insertVoteOK(){
	...
	var dc = new DataCollection();
	dc.add("ID",arr);
	Server.sendRequest("com.zving.cms.dataservice.Vote.getJSCode",dc,function(response){
		editor = FCKeditorAPI.GetInstance('Content');
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
		 ...
		 <z:tbutton
				...
				onClick="create()">
				<img src="../Icons/icon003a2.gif" width="20" height="20" />新建</z:tbutton></td>
		</tr>
	</table>
			...
			<table id="_Table1" width="750" border="0" cellpadding="20"
				...
				<tr>
					...
					<table width="100%" cellpadding="2" cellspacing="0">
						...
						<tr><td align="center"><strong>作&nbsp;者</strong></td>
							<td align="left">
							<strong><input name="Author" type="text" class="input1" id="Author"
								size="34" value="${Author}" /></strong></td></tr>
						<tr style="display:none">
					...
					<table width="100%" height="400" cellpadding="2" cellspacing="0">
						<tr>
							<td align="center"><textarea name="textarea" id="_Content"
								style="display:none">
				  ${Content}
				  </textarea> <textarea name="textarea" id="_Contents" style="display:none">
				  ${Contents}
							...
							<table width="95%" border="0" cellpadding="0" cellspacing="4"
								...
								<tr align="left">
									...
									<td><z:select id="NewsType" onChange="changeDocType()">
										...
										<span value="2">图片新闻</span>
										<span value="3">视频新闻</span>
								...
								<tr align="left" valign="middle">
									<td width="50" height="28" nowrap>所属频道</td>
									<td valign="middle">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr align="left" valign="middle">
											<td width="110">
							...
							<table width="95%" border="0" cellpadding="0" cellspacing="4"
								...
								<tr align="left" valign="top">
									...
									<td width="84%"><input name="text" type="text"
										...
										value="${PublishTime}" size="6" ztype="Time"
								...
								<tr align="left" valign="top">
									...
									<td><input name="text3" type="text" class="input1"
										...
										value="${DownlineTime}" size="6" ztype="Time"
								...
								<tr align="left" valign="top">
									<td>图片</td>
									<td><input name="LocalImageFlag" type="checkbox"
										id="LocalImageFlag" value="1" checked> <label
										for="LocalImageFlag">自动下载远程图片</label></td>
								</tr>
							</table>
							</td>
						</tr>
	...
	<table width="100%" id="pageBarTable">
		<tr>
			...
			<span class="add"><a href="#;" onClick="addPage()"
				alt="在当前页后插入"><img src="../Framework/Images/icon_+.gif"
				border="0" alt="在当前页后插入"></a></span> <span class="add"><a
				href="#;" onClick="deletePage()" alt="删除当前页"><img
				src="../Framework/Images/icon_-.gif" border="0" alt="删除当前页"></a></span></td>
