...
function add(){
	...
	function addSave(){
		...
		Server.sendRequest("com.zving.bbs.admin.ForumUserGroup.add",dc,function(response){
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#eeeeee" class="forumTable">
	...
	<z:datalist id="list1" method="com.zving.bbs.admin.ForumUserGroup.getList" page="false">
		<tr nowrap="nowrap">
			<td valign="middle">${Name}</td>
			<td><input type="text" value="${LowerScore}" size="7" id="LowerScore_${ID}" name="LowerScore"/>&nbsp;~&nbsp;${UpperScore}</td>
