...
<body>
	...
	<z:init method="com.zving.bbs.admin.PostAudit.init">
		请选择：
		<z:select id="TypeOptions" style="width:100px;" onChange="changeType();">
			<span value="0">未审核</span><span value="1">已忽略</span>
		</z:select>
		<z:select id="ForumOptions" style="width:100px;" onChange="changeForum();"><span value="0">所有板块</span>${ForumOptions}</z:select>
	</z:init></td>
	</tr><tr><td>
	<div style="padding:5px;">
		<z:datalist id="list1" method="com.zving.bbs.admin.PostAudit.getApplyDelPost" page="true" size="12">
		<div class="forumbox">
