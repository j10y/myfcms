...
function layer_Show(layer, show)
{
  ...
  if (show)
  {
  	document.getElementById('isItemid').style.display = 'none';
  	document.getElementById('templateNo').style.display = 'none';
    ...
    obj.style.visibility = "visible";
  	...
  	document.getElementById('isItemid').style.display = '';
  	document.getElementById('templateNo').style.display = '';
