	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<!-- center -->
				<td class="centerCell">
				<form method="post" action="<c:url value="/newsListPass.do"/>" name="form1">
				...
				<input type="hidden" name="isPass" value="<c:out value="${formInfo.isPass}"/>"/>
				...
				<table width="97%" border="0" cellpadding="5" cellspacing="1"
					...
					<tr class="bellContentRow">
						...
						<c:if test="${formInfo.isPass == '1'}"><fmt:message key="infoPublish.label.pass" /></c:if><c:if test="${formInfo.isPass == '0'}"><fmt:message key="infoPublish.label.cancelPass" /></c:if>:
						</td>
					</tr>
					...
					<c:if test="${formInfo.isPass == '1'}">
					<tr class="bellContentRow">
						<td class="bellContentLabelCell"><fmt:message key="infoPublish.label.whoPass" /></td>
						<td class="bellContentDataCell"><input type="text" id="whoPass" name="whoPass" value=""/></td>
					</tr>		
					</c:if>			
					<tr class="bellBottomRow">
						<td class="bellBottomCell" colspan="2"><input class="button_submit"
