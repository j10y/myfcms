		        ...
		        <table width="97%" border="0" cellpadding="5" cellspacing="1"
					class="bellContentTable">
		              <tr>
		                ...
		                <td><div align="center" class="font2"><br><br>
						<fmt:message key="${applicationException.message}"/><br><br><br><br>
				      	<input id="returnButton" name="returnButton" value="" type="button" onclick="oneStepBackward()"><br><br>
		               </div></td>
		              </tr>
		            </table>
		            </td>
