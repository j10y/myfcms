...
public class TaskDaoImpl extends BaseDaoImpl<TaskImpl> implements TaskDao {
	...
	public List<TaskImpl> getTasksByUserId(String userId, PagingBean pb) {
		...
		hqlSb
				.append("select task from org.jbpm.pvm.internal.task.TaskImpl task left join task.participations pt where task.assignee=?");
	...
	public List<JbpmTask> getByActivityNameVarKeyLongVal(String activityName, String varKey,
			Long value) {
		...
		Collection jbpmtask = this.jdbcTemplate.query(sql, new Object[] { activityName, varKey,
				value }, new RowMapper() {
 ...
 * Qualified Name: com.htsoft.oa.dao.flow.impl.TaskDaoImpl JD-Core Version:
 * 0.5.4
 */