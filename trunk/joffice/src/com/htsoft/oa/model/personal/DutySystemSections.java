 ...
 public class DutySystemSections
 {
   ...
   {
     return this.day0 + "|" + this.day1 + "|" + this.day2 + "|" + this.day3 + "|" + this.day4 + "|" + this.day5 + "|" + this.day6;
   }
 
   public String dayIdToString()
   {
     return this.dayId0 + "|" + this.dayId1 + "|" + this.dayId2 + "|" + this.dayId3 + "|" + this.dayId4 + "|" + this.dayId5 + "|" + this.dayId6;
   }
 }

/* Location:           E:\JOffice1.3安装试用版10人\joffice131Tomcat6\tomcat6-joffice\webapps\joffice1.3.1\WEB-INF\classes\
 * Qualified Name:     com.htsoft.oa.model.personal.DutySystemSections
