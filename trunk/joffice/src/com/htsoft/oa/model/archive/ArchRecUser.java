...
public class ArchRecUser extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.archRecId, rhs.archRecId).append(this.userId,
				rhs.userId).append(this.fullname, rhs.fullname).append(this.depName, rhs.depName)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.archRecId)
				.append(this.userId).append(this.fullname).append(this.depName).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("archRecId", this.archRecId).append("userId",
				this.userId).append("fullname", this.fullname).append("depName", this.depName)
				.toString();
	}
}
