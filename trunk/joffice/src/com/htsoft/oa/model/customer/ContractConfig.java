...
public class ContractConfig extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.configId, rhs.configId).append(this.itemName,
				rhs.itemName).append(this.itemSpec, rhs.itemSpec).append(this.amount, rhs.amount)
				.append(this.notes, rhs.notes).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.configId).append(
				this.itemName).append(this.itemSpec).append(this.amount).append(this.notes)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("configId", this.configId).append("itemName",
				this.itemName).append("itemSpec", this.itemSpec).append("amount", this.amount)
