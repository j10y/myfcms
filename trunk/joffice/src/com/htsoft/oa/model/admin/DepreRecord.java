...
public class DepreRecord extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.recordId, rhs.recordId).append(this.workCapacity,
				rhs.workCapacity).append(this.depreAmount, rhs.depreAmount).append(this.calTime,
				rhs.calTime).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.recordId).append(
				this.workCapacity).append(this.depreAmount).append(this.calTime).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("recordId", this.recordId).append("workCapacity",
				this.workCapacity).append("depreAmount", this.depreAmount).append("calTime",
				this.calTime).toString();
	}
}
