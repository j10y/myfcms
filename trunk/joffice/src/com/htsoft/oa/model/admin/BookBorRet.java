...
public class BookBorRet extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.recordId, rhs.recordId).append(this.borrowTime,
				rhs.borrowTime).append(this.returnTime, rhs.returnTime).append(this.lastReturnTime,
				rhs.lastReturnTime).append(this.borrowIsbn, rhs.borrowIsbn).append(this.bookName,
				rhs.bookName).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.recordId).append(
				this.borrowTime).append(this.returnTime).append(this.lastReturnTime).append(
				this.borrowIsbn).append(this.bookName).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("recordId", this.recordId).append("borrowTime",
				this.borrowTime).append("returnTime", this.returnTime).append("lastReturnTime",
				this.lastReturnTime).append("borrowIsbn", this.borrowIsbn).append("bookName",
