...
public class DocPrivilege extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.privilegeId, rhs.privilegeId).append(this.rights,
				rhs.rights).append(this.udrId, rhs.udrId).append(this.udrName, rhs.udrName).append(
				this.flag, rhs.flag).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.privilegeId).append(
				this.rights).append(this.udrId).append(this.udrName).append(this.flag).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("privilegeId", this.privilegeId).append("rights",
				this.rights).append("udrId", this.udrId).append("udrName", this.udrName).append(
