...
public class PhoneBook extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.phoneId, rhs.phoneId).append(this.fullname,
				rhs.fullname).append(this.title, rhs.title).append(this.birthday, rhs.birthday)
				.append(this.nickName, rhs.nickName).append(this.duty, rhs.duty).append(
						this.spouse, rhs.spouse).append(this.childs, rhs.childs).append(
						this.companyName, rhs.companyName).append(this.companyAddress,
						rhs.companyAddress).append(this.companyPhone, rhs.companyPhone).append(
						this.companyFax, rhs.companyFax).append(this.homeAddress, rhs.homeAddress)
				.append(this.homeZip, rhs.homeZip).append(this.mobile, rhs.mobile).append(
						this.phone, rhs.phone).append(this.email, rhs.email).append(this.qqNumber,
						rhs.qqNumber).append(this.msn, rhs.msn).append(this.note, rhs.note).append(
						this.isShared, rhs.isShared).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.phoneId)
				.append(this.fullname).append(this.title).append(this.birthday).append(
						this.nickName).append(this.duty).append(this.spouse).append(this.childs)
				.append(this.companyName).append(this.companyAddress).append(this.companyPhone)
				.append(this.companyFax).append(this.homeAddress).append(this.homeZip).append(
						this.mobile).append(this.phone).append(this.email).append(this.qqNumber)
				.append(this.msn).append(this.note).append(this.isShared).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("phoneId", this.phoneId).append("fullname",
				this.fullname).append("title", this.title).append("birthday", this.birthday)
				.append("nickName", this.nickName).append("duty", this.duty).append("spouse",
						this.spouse).append("childs", this.childs).append("companyName",
						this.companyName).append("companyAddress", this.companyAddress).append(
						"companyPhone", this.companyPhone).append("companyFax", this.companyFax)
				.append("homeAddress", this.homeAddress).append("homeZip", this.homeZip).append(
						"mobile", this.mobile).append("phone", this.phone).append("email",
						this.email).append("qqNumber", this.qqNumber).append("msn", this.msn)
				.append("note", this.note).append("isShared", this.isShared).toString();
	}
