 ...
 public class SalaryPayoffAction extends BaseAction
 {
   ...
   public String save()
   {
     ...
     BigDecimal acutalAmount = this.salaryPayoff.getStandAmount().add(this.salaryPayoff.getEncourageAmount()).subtract(this.salaryPayoff.getDeductAmount());
   ...
   public String check()
   {
     SalaryPayoff checkSalaryPayoff = (SalaryPayoff)this.salaryPayoffService.get(new Long(this.recordId.longValue()));
   ...
   public String personal()
   {
     ...
     for (SalaryPayoff salaryDetail : list) {
       ...
       List items = this.standSalaryItemService.getAllByStandardId(salaryDetail.getStandardId());
