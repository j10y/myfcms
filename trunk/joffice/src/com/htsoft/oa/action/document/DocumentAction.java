...
public class DocumentAction extends BaseAction {
	...
	public String shareList() {
		...
		List list = this.documentService.findByIsShared(this.document, this.from, this.to, appUser
				.getUserId(), arrayList, depId, pb);
	...
	public String publicList() {
		...
		List list = this.documentService.findByPublic(path, this.document, this.from, this.to,
