...
public class DocumentAction extends BaseAction {
	...
	public String shareList() {
		...
		List<Document> list = this.documentService.findByIsShared(this.document, this.from,
				this.to, appUser.getUserId(), arrayList, depId, pb);
	...
	public String list() {
		...
		filter.addFilter("Q_docFolder.appUser.userId_L_EQ", ContextUtil.getCurrentUserId()
				.toString());
	...
	public String publicList() {
		...
		List<Document> list = this.documentService.findByPublic(path, this.document, this.from,
				this.to, ContextUtil.getCurrentUser(), pb);
		Type type = new TypeToken<List<Document>>() {
		}.getType();
		StringBuffer buff = new StringBuffer("{success:true,'totalCounts':").append(
				pb.getTotalItems()).append(",result:");
	...
	public String right() {
		...
		setJsonString("{success:true,rightM:'" + rightM + "',rightD:'" + rightD + "',docName:'"
				+ document.getDocName() + "'}");
		return "success";
	}
