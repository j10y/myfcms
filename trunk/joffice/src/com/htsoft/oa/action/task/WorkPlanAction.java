   ...
   public String save()
   {
     ...
     if (isPersonal != 1) {
       if (StringUtils.isNotEmpty(issueScopeIds)) {
         boolean b = this.planAttendService.deletePlanAttend(this.workPlan.getPlanId(), Short.valueOf(ISDEPARTMENT), Short.valueOf(NOTPRIMARY));
         if (b) {
       ...
       if (StringUtils.isNotEmpty(participantsIds)) {
         boolean b = this.planAttendService.deletePlanAttend(this.workPlan.getPlanId(), Short.valueOf(NOTDEPARTMENT), Short.valueOf(NOTPRIMARY));
         if (b) {
       ...
       if (StringUtils.isNotEmpty(principalIds)) {
         boolean b = this.planAttendService.deletePlanAttend(this.workPlan.getPlanId(), Short.valueOf(NOTDEPARTMENT), Short.valueOf(ISPRIMARY));
         if (b) {
