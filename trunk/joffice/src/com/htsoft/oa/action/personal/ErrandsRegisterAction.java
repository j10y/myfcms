...
public class ErrandsRegisterAction extends BaseAction {
	...
	public String save() {
		...
		this.errandsRegister.setStatus((short) 0);
		this.errandsRegisterService.save(this.errandsRegister);

		if ((ErrandsRegister.FLAG_LEAVE.equals(this.errandsRegister.getFlag())) && (isNew)) {
 ...
 * Qualified Name: com.htsoft.oa.action.personal.ErrandsRegisterAction JD-Core
 * Version: 0.5.4
 */