 ...
 public class InStockAction extends BaseAction
 {
   ...
   public String save()
   {
     ...
     if (this.inStock.getBuyId() == null) {
       goods.setStockCounts(Integer.valueOf(goods.getStockCounts().intValue() + this.inStock.getInCounts().intValue()));
     } else {
       ...
       if (!oldInCount.equals(newInCount)) {
         goods.setStockCounts(Integer.valueOf(goods.getStockCounts().intValue() - oldInCount.intValue() + newInCount.intValue()));
       }
     }
