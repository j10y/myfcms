 ...
 public class OfficeGoodsTypeAction extends BaseAction
 {
   ...
   public String list()
   {
     ...
     List list = this.officeGoodsTypeService.getAll(filter);
   ...
   public String tree()
   {
     ...
     List list = this.officeGoodsTypeService.getAll();
   ...
   public String get()
   {
     OfficeGoodsType officeGoodsType = (OfficeGoodsType)this.officeGoodsTypeService.get(this.typeId);
     Gson gson = new Gson();
