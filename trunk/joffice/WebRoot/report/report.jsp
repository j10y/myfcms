...
ReportParamService reportParamService = (ReportParamService)AppUtil.getBean("reportParamService");
...
while(it.hasNext()){
 ...
 String reportPath = "";
 ReportTemplateService reportTemplateService = (ReportTemplateService)AppUtil.getBean("reportTemplateService");
