 ...
 public class ZCTagSchema extends Schema
 {
   ...
   protected static final String _UpdateAllSQL = "update ZCTag set ID=?,Code=?,Name=?,SiteID=?,Type=?,TagText=?,Prop1=?,Prop2=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
