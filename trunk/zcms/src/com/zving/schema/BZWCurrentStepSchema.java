 ...
 public class BZWCurrentStepSchema extends Schema
 {
   private Long ID;
   ...
   public static final String _TableCode = "BZWCurrentStep";
   public static final String _NameSpace = "com.zving.schema";
   protected static final String _InsertAllSQL = "insert into BZWCurrentStep values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
   protected static final String _UpdateAllSQL = "update BZWCurrentStep set ID=?,EntryID=?,StepID=?,ActionID=?,Owner=?,StartDate=?,FinishDate=?,DueDate=?,Status=?,Caller=?,Memo=?,BackupNo=?,BackupOperator=?,BackupTime=?,BackupMemo=? where ID=? and BackupNo=?";
   protected static final String _DeleteSQL = "delete from BZWCurrentStep  where ID=? and BackupNo=?";
   protected static final String _FillAllSQL = "select * from BZWCurrentStep  where ID=? and BackupNo=?";
 
   public BZWCurrentStepSchema()
   {
   ...
   protected Schema newInstance() {
     return new BZWCurrentStepSchema();
   }
   ...
   public BZWCurrentStepSet query() {
     return query(null, -1, -1);
   }
 
   public BZWCurrentStepSet query(QueryBuilder qb) {
     return query(qb, -1, -1);
   }
 
   public BZWCurrentStepSet query(int pageSize, int pageIndex) {
     return query(null, pageSize, pageIndex);
   }
 
   public BZWCurrentStepSet query(QueryBuilder qb, int pageSize, int pageIndex) {
     return ((BZWCurrentStepSet)querySet(qb, pageSize, pageIndex));
   }
 ...
 * Qualified Name:     com.zving.schema.BZWCurrentStepSchema
