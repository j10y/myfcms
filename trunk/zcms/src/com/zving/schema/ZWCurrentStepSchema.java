 ...
 public class ZWCurrentStepSchema extends Schema
 {
   private Long ID;
   ...
   public static final String _TableCode = "ZWCurrentStep";
   public static final String _NameSpace = "com.zving.schema";
   protected static final String _InsertAllSQL = "insert into ZWCurrentStep values(?,?,?,?,?,?,?,?,?,?,?)";
   protected static final String _UpdateAllSQL = "update ZWCurrentStep set ID=?,EntryID=?,StepID=?,ActionID=?,Owner=?,StartDate=?,FinishDate=?,DueDate=?,Status=?,Caller=?,Memo=? where ID=?";
   protected static final String _DeleteSQL = "delete from ZWCurrentStep  where ID=?";
   protected static final String _FillAllSQL = "select * from ZWCurrentStep  where ID=?";
 
   public ZWCurrentStepSchema()
   {
   ...
   protected Schema newInstance() {
     return new ZWCurrentStepSchema();
   }
   ...
   public ZWCurrentStepSet query() {
     return query(null, -1, -1);
   }
 
   public ZWCurrentStepSet query(QueryBuilder qb) {
     return query(qb, -1, -1);
   }
 
   public ZWCurrentStepSet query(int pageSize, int pageIndex) {
     return query(null, pageSize, pageIndex);
   }
 
   public ZWCurrentStepSet query(QueryBuilder qb, int pageSize, int pageIndex) {
     return ((ZWCurrentStepSet)querySet(qb, pageSize, pageIndex));
   }
 ...
 * Qualified Name:     com.zving.schema.ZWCurrentStepSchema
