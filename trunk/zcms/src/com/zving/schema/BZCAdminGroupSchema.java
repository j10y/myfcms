 ...
 public class BZCAdminGroupSchema extends Schema
 {
   ...
   public static final SchemaColumn[] _Columns = { 
     ...
     new SchemaColumn("BackupNo", 1, 23, 15, 0, true, true), 
     new SchemaColumn("BackupOperator", 1, 24, 200, 0, true, false), 
     new SchemaColumn("BackupTime", 0, 25, 0, 0, true, false), 
     new SchemaColumn("BackupMemo", 1, 26, 50, 0, false, false) };
   ...
   public void setV(int i, Object v) {
     ...
     if (i == 22) { this.ModifyTime = ((Date)v); return; }
     if (i == 23) { this.BackupNo = ((String)v); return; }
     if (i == 24) { this.BackupOperator = ((String)v); return; }
     if (i == 25) { this.BackupTime = ((Date)v); return; }
     if (i != 26) return; this.BackupMemo = ((String)v); return;
   }
   ...
   public Object getV(int i) {
     ...
     if (i == 23) return this.BackupNo;
     if (i == 24) return this.BackupOperator;
     if (i == 25) return this.BackupTime;
     if (i == 26) return this.BackupMemo;
     return null;
   }
 ...
 * Qualified Name:     com.zving.schema.BZCAdminGroupSchema
