 ...
 public class FileCachedMapx
 {
     ...
     throws IOException
   {
     ...
     {
       FileCachedMapx tmp88_87 = this; tmp88_87.maxFileIndex = (short)(tmp88_87.maxFileIndex + 1);
     ...
     {
       FileCachedMapx tmp274_273 = this; tmp274_273.maxFileIndex = (short)(tmp274_273.maxFileIndex + 1);
       BufferedRandomAccessFile fk = new BufferedRandomAccessFile(this.cacheDirectory + "key" + this.maxFileIndex + ".dat", 
         "rw");
       BufferedRandomAccessFile fv = new BufferedRandomAccessFile(
         this.cacheDirectory + "value" + this.maxFileIndex + ".dat", "rw");
     ...
     throws IOException
   {
     ...
     if (newDataLength > key.DataLength) {
       ...
       if (newSize > 2097152000)
       {
         ...
         f.writeByte(0);
         FileCachedMapx tmp115_114 = this; tmp115_114.maxFileIndex = (short)(tmp115_114.maxFileIndex + 1);
   ...
   private Object toObject(byte[] bs)
   {
     ...
     if (type == 5) {
       ...
       i = 0; break label137:
       while (true) { arr[i] = NumberUtil.toInt(bs, i * 4);
     ...
     if (type == 6) {
       ...
       i = 0; break label183:
       while (true) { arr[i] = NumberUtil.toInt(bs, i * 8);
     ...
     if (type == 7) {
       ...
       int i = 0; break label311:
       while (true) { r[i] = ((String)arr.get(i));
       ...
       if (o == null) {
         ...
         if (key == null) {
           ...
           if (this.size > this.total * 0.75D) {
             resize(); break label110:
           }
         }
         writeData(k, value); break label110:
       }
   ...
   public static class Entry
   {
     ...
     protected static Entry first(FileCachedMapx fcm)
     {
       ...
       //   3: monitorenter
       //   4: aload_0
       //   5: invokestatic 80	com/zving/framework/utility/FileCachedMapx:access$2	(Lcom/zving/framework/utility/FileCachedMapx;)[Lcom/zving/framework/utility/BufferedRandomAccessFile;
       //   8: ifnonnull +7 -> 15
       //   11: aload_0
       //   12: invokestatic 83	com/zving/framework/utility/FileCachedMapx:access$3	(Lcom/zving/framework/utility/FileCachedMapx;)V
       //   15: aload_0
       //   16: invokestatic 87	com/zving/framework/utility/FileCachedMapx:access$4	(Lcom/zving/framework/utility/FileCachedMapx;)[Lcom/zving/framework/utility/BufferedRandomAccessFile;
       //   19: iconst_0
       //   20: aaload
       //   21: astore_2
       //   22: iconst_0
       ...
       //   27: dup
       //   28: invokespecial 90	com/zving/framework/utility/FileCachedMapx$Key:<init>	()V
       //   31: astore 4
       //   33: goto +119 -> 152
       //   36: aload_2
       //   37: iload_3
       //   38: i2l
       //   39: invokevirtual 50	com/zving/framework/utility/BufferedRandomAccessFile:seek	(J)V
       //   42: aload_2
       //   43: invokevirtual 91	com/zving/framework/utility/BufferedRandomAccessFile:readByte	()B
       //   46: istore 5
       //   48: aload 4
       //   50: aload_2
       //   51: invokevirtual 95	com/zving/framework/utility/BufferedRandomAccessFile:readShort	()S
       //   54: putfield 39	com/zving/framework/utility/FileCachedMapx$Key:DataFileIndex	S
       //   57: aload 4
       //   59: aload_2
       //   60: invokevirtual 99	com/zving/framework/utility/BufferedRandomAccessFile:readInt	()I
       //   63: putfield 56	com/zving/framework/utility/FileCachedMapx$Key:DataLength	I
       //   66: aload 4
       //   68: aload_2
       //   69: invokevirtual 99	com/zving/framework/utility/BufferedRandomAccessFile:readInt	()I
       //   72: putfield 43	com/zving/framework/utility/FileCachedMapx$Key:DataAddress	I
       //   75: aload_2
       //   76: invokevirtual 95	com/zving/framework/utility/BufferedRandomAccessFile:readShort	()S
       //   79: istore 6
       //   81: aload 4
       //   83: iload 6
       //   85: bipush 22
       //   87: iadd
       //   88: i2s
       //   89: putfield 47	com/zving/framework/utility/FileCachedMapx$Key:KeyLength	S
       //   92: iload 5
       //   94: iconst_1
       //   95: if_icmpne +49 -> 144
       //   98: iload 6
       ...
       //   104: aload_2
       //   105: aload 7
       //   107: invokevirtual 59	com/zving/framework/utility/BufferedRandomAccessFile:read	([B)I
       //   110: pop
       //   111: aload 4
       ...
       //   122: putfield 25	com/zving/framework/utility/FileCachedMapx$Key:KeyString	Ljava/lang/String;
       //   125: aload 4
       //   127: iload_3
       //   128: putfield 108	com/zving/framework/utility/FileCachedMapx$Key:keyAddress	I
       //   131: new 1	com/zving/framework/utility/FileCachedMapx$Entry
       //   134: dup
       //   135: aload_0
       //   136: aload 4
       //   138: invokespecial 111	com/zving/framework/utility/FileCachedMapx$Entry:<init>	(Lcom/zving/framework/utility/FileCachedMapx;Lcom/zving/framework/utility/FileCachedMapx$Key;)V
       //   141: aload_1
       //   142: monitorexit
       //   143: areturn
       //   144: iload_3
       ...
       //   151: istore_3
       //   152: aload_2
       //   153: invokevirtual 113	com/zving/framework/utility/BufferedRandomAccessFile:length	()J
       //   156: iload_3
       //   157: i2l
       //   158: lcmp
       //   159: ifgt -123 -> 36
     ...
     public Entry next()
     {
       // Byte code:
       //   0: aload_0
       //   1: getfield 15	com/zving/framework/utility/FileCachedMapx$Entry:fcm	Lcom/zving/framework/utility/FileCachedMapx;
       //   4: dup
       //   5: astore_1
       //   6: monitorenter
       //   7: aload_0
       //   8: getfield 15	com/zving/framework/utility/FileCachedMapx$Entry:fcm	Lcom/zving/framework/utility/FileCachedMapx;
       //   11: invokestatic 87	com/zving/framework/utility/FileCachedMapx:access$4	(Lcom/zving/framework/utility/FileCachedMapx;)[Lcom/zving/framework/utility/BufferedRandomAccessFile;
       //   14: aload_0
       //   15: getfield 17	com/zving/framework/utility/FileCachedMapx$Entry:key	Lcom/zving/framework/utility/FileCachedMapx$Key;
       //   18: getfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   21: aaload
       //   22: astore_2
       //   23: aload_0
       //   24: getfield 17	com/zving/framework/utility/FileCachedMapx$Entry:key	Lcom/zving/framework/utility/FileCachedMapx$Key;
       //   27: getfield 108	com/zving/framework/utility/FileCachedMapx$Key:keyAddress	I
       //   30: aload_0
       //   31: getfield 17	com/zving/framework/utility/FileCachedMapx$Entry:key	Lcom/zving/framework/utility/FileCachedMapx$Key;
       //   34: getfield 47	com/zving/framework/utility/FileCachedMapx$Key:KeyLength	S
       //   37: iadd
       //   38: istore_3
       //   39: new 26	com/zving/framework/utility/FileCachedMapx$Key
       //   42: dup
       //   43: invokespecial 90	com/zving/framework/utility/FileCachedMapx$Key:<init>	()V
       //   46: astore 4
       //   48: aload 4
       //   50: aload_0
       //   51: getfield 17	com/zving/framework/utility/FileCachedMapx$Entry:key	Lcom/zving/framework/utility/FileCachedMapx$Key;
       //   54: getfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   57: putfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   60: iload_3
       //   61: i2l
       //   62: aload_2
       //   63: invokevirtual 113	com/zving/framework/utility/BufferedRandomAccessFile:length	()J
       //   66: lcmp
       //   67: ifne +58 -> 125
       //   70: aload_0
       //   71: getfield 17	com/zving/framework/utility/FileCachedMapx$Entry:key	Lcom/zving/framework/utility/FileCachedMapx$Key;
       //   74: getfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   77: aload_0
       //   78: getfield 15	com/zving/framework/utility/FileCachedMapx$Entry:fcm	Lcom/zving/framework/utility/FileCachedMapx;
       //   81: invokestatic 131	com/zving/framework/utility/FileCachedMapx:access$5	(Lcom/zving/framework/utility/FileCachedMapx;)S
       //   84: if_icmpne +7 -> 91
       //   87: aload_1
       //   88: monitorexit
       //   89: aconst_null
       ...
       //   91: aload 4
       //   93: dup
       //   94: getfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   97: iconst_1
       //   98: iadd
       //   99: i2s
       //   100: putfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   103: aload 4
       //   105: iconst_0
       //   106: putfield 108	com/zving/framework/utility/FileCachedMapx$Key:keyAddress	I
       //   109: aload_0
       //   110: getfield 15	com/zving/framework/utility/FileCachedMapx$Entry:fcm	Lcom/zving/framework/utility/FileCachedMapx;
       //   113: invokestatic 87	com/zving/framework/utility/FileCachedMapx:access$4	(Lcom/zving/framework/utility/FileCachedMapx;)[Lcom/zving/framework/utility/BufferedRandomAccessFile;
       //   116: aload 4
       //   118: getfield 128	com/zving/framework/utility/FileCachedMapx$Key:KeyFileIndex	S
       //   121: aaload
       //   122: astore_2
       //   123: iconst_0
       //   124: istore_3
       ...
       //   135: iload_3
       //   136: i2l
       //   137: invokevirtual 50	com/zving/framework/utility/BufferedRandomAccessFile:seek	(J)V
       //   140: aload_2
       //   141: invokevirtual 91	com/zving/framework/utility/BufferedRandomAccessFile:readByte	()B
       //   144: istore 5
       //   146: aload 4
       //   148: aload_2
       //   149: invokevirtual 95	com/zving/framework/utility/BufferedRandomAccessFile:readShort	()S
       //   152: putfield 39	com/zving/framework/utility/FileCachedMapx$Key:DataFileIndex	S
       //   155: aload 4
       //   157: aload_2
       //   158: invokevirtual 99	com/zving/framework/utility/BufferedRandomAccessFile:readInt	()I
       //   161: putfield 56	com/zving/framework/utility/FileCachedMapx$Key:DataLength	I
       //   164: aload 4
       //   166: aload_2
       //   167: invokevirtual 99	com/zving/framework/utility/BufferedRandomAccessFile:readInt	()I
       //   170: putfield 43	com/zving/framework/utility/FileCachedMapx$Key:DataAddress	I
       //   173: aload_2
       //   174: invokevirtual 95	com/zving/framework/utility/BufferedRandomAccessFile:readShort	()S
       //   177: istore 6
       //   179: iload 5
       //   181: iconst_1
       ...
       //   191: aload_2
       //   192: aload 7
       //   194: invokevirtual 59	com/zving/framework/utility/BufferedRandomAccessFile:read	([B)I
       //   197: pop
       //   198: aload 4
       ...
       //   209: putfield 25	com/zving/framework/utility/FileCachedMapx$Key:KeyString	Ljava/lang/String;
       //   212: aload 4
       //   214: iload 6
       //   216: bipush 22
       //   218: iadd
       //   219: i2s
       //   220: putfield 47	com/zving/framework/utility/FileCachedMapx$Key:KeyLength	S
       //   223: aload 4
       //   225: iload_3
       //   226: putfield 108	com/zving/framework/utility/FileCachedMapx$Key:keyAddress	I
       //   229: new 1	com/zving/framework/utility/FileCachedMapx$Entry
       //   232: dup
       //   233: aload_0
       //   234: getfield 15	com/zving/framework/utility/FileCachedMapx$Entry:fcm	Lcom/zving/framework/utility/FileCachedMapx;
       //   237: aload 4
       //   239: invokespecial 111	com/zving/framework/utility/FileCachedMapx$Entry:<init>	(Lcom/zving/framework/utility/FileCachedMapx;Lcom/zving/framework/utility/FileCachedMapx$Key;)V
       //   242: aload_1
       //   243: monitorexit
       //   244: areturn
       //   245: iload_3
       ...
       //   252: istore_3
       //   253: aload_2
       //   254: invokevirtual 113	com/zving/framework/utility/BufferedRandomAccessFile:length	()J
       //   257: iload_3
       //   258: i2l
       //   259: lcmp
       //   260: ifgt -126 -> 134
 ...
 * Qualified Name:     com.zving.framework.utility.FileCachedMapx
