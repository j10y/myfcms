 ...
 public class GIFEncoder extends ImageEncoder
 {
     ...
     throws IOException
   {
     ...
     GIFEncode(this.out, this.width, this.height, this.interlace, 0, transparentIndex, logColors, reds, grns, blus);
   }
   ...
   void BumpPixel()
   {
     ...
     if (this.curx == this.Width) {
       ...
       if (!(this.Interlace))
         ...
         case 0:
           this.cury += 8;
           if (this.cury < this.Height) return;
           this.Pass += 1;
           this.cury = 4;
 ...
 * Qualified Name:     com.zving.framework.utility.GIFEncoder
