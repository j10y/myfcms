...
public class ChineseSpelling {
	...
	static {
		...
		chartable = new char[] { 21834, 33453, 25830, 25645, 34558, 21457, 22134, 21704, 21704,
				20987, 21888, 22403, 22920, 25343, 21734, 21866, 26399, 28982, 25746, 22604, 22604,
				22604, 25366, 26132, 21387, 21277, 24231 };

		alphatable = new char[] { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M',
 ...
 * com.zving.framework.utility.ChineseSpelling JD-Core Version: 0.5.3
 */