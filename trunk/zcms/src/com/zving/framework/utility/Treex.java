 ...
 public class Treex
 {
   ...
   private static void dealNode(DataTable dt, TreeNode tn, Mapx map, String identifierColumnName, String parentIdentifierColumnName)
   {
     ...
     for (int i = 0; i < dt.getRowCount(); ++i) {
       ...
       if ((!(parentID.equals(ID))) || 
         (map.get(ChildID) == null)) continue;
       dealNode(dt, tn.addChild(dt.getDataRow(i)), map, identifierColumnName, parentIdentifierColumnName);
     }
   }
 ...
 * Qualified Name:     com.zving.framework.utility.Treex
