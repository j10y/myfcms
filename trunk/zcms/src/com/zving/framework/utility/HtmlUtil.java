...
public class HtmlUtil {
	...
	public static DataTable codeToDataTable(String CodeType) {
		return new QueryBuilder(
				"select CodeName,CodeValue from ZDCode where ParentCode = ? Order by CodeOrder",
	...
	public static String dataTableToRadios(String name, DataTable dt, Object checkedValue,
			boolean direction) {
		StringBuffer sb = new StringBuffer();
	...
	public static String arrayToRadios(String name, String[] array, Object checkedValue,
			boolean direction) {
		StringBuffer sb = new StringBuffer();
	...
	public static String arrayToCheckboxes(String name, String[] array, String[] checkedArray,
			String onclick, boolean direction) {
		StringBuffer sb = new StringBuffer();
		for (int k = 0; k < array.length; ++k) {
			String value = array[k];
	...
	public static void htmlTableToExcel(OutputStream os, HtmlTable table, String[] widths,
			String[] indexes, String[] rows) {
					...
					for (k = 0; k < rows.length; ++k) {
						...
						if (k == table.getChildren().size() - 1) {
							if ((StringUtil.isNotEmpty(ztype))
									&& (ztype.equalsIgnoreCase("pagebar"))) {
								break label897;
							}
							String html = table.getTR(n).getInnerHTML();
							if (StringUtil.isEmpty(html))
								break label897;
							if (html.indexOf("PageBarIndex") > 0) {
								break label897;
							}
						}
 ...
 * com.zving.framework.utility.HtmlUtil JD-Core Version: 0.5.3
 */