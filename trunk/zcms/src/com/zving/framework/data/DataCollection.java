			...
			for (int i = 0; i < elements.size(); ++i) {
				...
				if (type.equals("String")) {
					...
					if (type.equals("StringArray")) {
						...
						t[0] = t[0].substring(1);
						t[(t.length - 1)] = t[(t.length - 1)].substring(0, t[(t.length - 1)]
								.length() - 2);
						put(id, t);
					} else {
						if (type.equals("IntArray")) {
							...
							if (type.equals("Schema")) {
								Class c = Class.forName(ele.attributeValue("NameSpace") + "."
								...
								Class cSet = Class.forName(ele.attributeValue("NameSpace") + "."
 ...
 * com.zving.framework.data.DataCollection JD-Core Version: 0.5.3
 */