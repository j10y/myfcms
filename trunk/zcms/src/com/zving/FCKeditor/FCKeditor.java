...
public class FCKeditor {
	...
	public String create() {
		...
		if (isCompatible()) {
			strEditor.append("<input type=\"hidden\" id=\"" + this.instanceName + "\" name=\""
					+ this.instanceName + "\" value=\"" + encodedValue + "\">");

			strEditor.append(createConfigHTML());
			strEditor.append(createIFrameHTML());
		} else {
			strEditor.append("<TEXTAREA name=\"" + this.instanceName + "\" rows=\"" + this.row
					+ "\" cols=\"40\" style=\"WIDTH: " + this.width + "; HEIGHT: " + this.height
	...
	private String createConfigHTML() {
		...
		return "<input type=\"hidden\" id=\"" + this.instanceName + "___Config\" value=\""
				+ configStr + "\">";
	}
	...
	private String createIFrameHTML() {
		...
		return "<iframe id=\"" + this.instanceName + "___Frame\" src=\"" + sLink + "\" width=\""
 ...
 * com.zving.FCKeditor.FCKeditor JD-Core Version: 0.5.3
 */