 ...
 public class FromWeb extends Page
 {
   ...
   public void execute() {
     ...
     ltt = new LongTimeTask(id) { private final long val$id;
 
       public void execute() { ZCWebGatherSchema wg = new ZCWebGatherSchema();
         wg.setID(this.val$id);
         wg.fill();
         CrawlConfig cc = new CrawlConfig();
         cc.parse(wg);
 ...
 * Qualified Name:     com.zving.datachannel.FromWeb
