...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.zving.cms.stat.report.SourceReport.getSourceChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.zving.cms.stat.report.SourceReport.dgSourceDataBind"
					autoFill="false" page="false">
					<table width="100%" cellpadding="2" cellspacing="0"
						class="dataTable">
						<tr ztype="head" class="dataTableHead">
							<td width="26%" sortfield="orderflag" direction="">日期</td>
							<td width="25%">直接输入</td>
							<td width="25%">搜索引擎</td>
							<td width="24%">相关网站</td>
						</tr>
