	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>最近访问记录:</strong></div>
				</td>
			</tr>
			<tr>
				<td
				...
				<z:datagrid id="dg1"
					method="com.zving.cms.stat.report.LastVisitReport.dg1DataBind"
					autoFill="false">
					<table width="100%" cellpadding="2" cellspacing="0"
						class="dataTable">
						<tr ztype="head" class="dataTableHead">
							<td width="9%">访问时间</td>
							<td width="18%"><strong>IP地址</strong></td>
							<td width="21%">所在地区</td>
							<td width="11%">浏览器</td>
							<td width="41%">访问URL</td>
						</tr>
						<tr>
							<td>${AddTime}</td>
							<td>${IP}</td>
