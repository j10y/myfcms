...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.zving.cms.stat.report.DistrictReport.getChartData");
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<div style="float:left;"><strong>地区分布:</strong> &nbsp; <z:select
					...
					style="width:80px; " ztype='date'> 至 <input name="text2"
					type="text" id="EndDate" style="width:80px; " verify="Date"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.zving.cms.stat.report.DistrictReport.dg1DataBind"
					...
					<table width="100%" cellpadding="2" cellspacing="0"
						...
						<tr ztype="head" class="dataTableHead">
							...
							<td width="16%"><strong>百分比</strong></td>
							<td width="14%">趋势</td>
						</tr>
						<tr>
							<td>${Item}</td>
