...
<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <z:tree id="tree1" style="height:410px" method="com.zving.cms.dataservice.OuterDocument.cmsTreeDataBind">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <z:datagrid id="dg1" method="com.zving.cms.dataservice.OuterDocument.cmsDataBind" size="12">
